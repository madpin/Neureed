...
/**
 * Available preference view types
 */
export type ViewType = 'profile' | 'appearance' | 'articleDisplay' | 'reading' | 'learning' | 'llm' | 'feeds';

/**
 * Navigation item for preference views
 */
...
/**
 * Get the display label for a preference view
 *
...
/**
 * Navigation items for the preferences modal
 *
 * Each item includes a view type, label, and SVG icon.
 * These are used to render the sidebar navigation (desktop) and
