...
export function RelevanceScore({
  ...
  return (
    <div className="group relative inline-flex items-center">
      ...
      {showTooltip && (
        <div className="pointer-events-none absolute bottom-full left-1/2 z-10 mb-2 hidden -translate-x-1/2 transform rounded-lg bg-gray-900 px-3 py-2 text-xs text-white shadow-lg group-hover:block dark:bg-gray-700">
          {tooltipContent}
